...
var Autolink = function (_Component) {
  ...
  _createClass(Autolink, [{
    ...
    value: function renderLink(text, url, match) {
      var truncated = this.props.truncate ? _autolinker2.default.truncate.TruncateSmart(text, this.props.truncateLength, this.props.truncateChars) : text;
...
Autolink.propTypes = {
  ...
  truncate: _reactNative.PropTypes.bool,
  truncateChars: _reactNative.PropTypes.string,
  truncateLength: _reactNative.PropTypes.number,
